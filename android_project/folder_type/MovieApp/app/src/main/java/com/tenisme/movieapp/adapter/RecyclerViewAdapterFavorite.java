...
public class RecyclerViewAdapterFavorite extends RecyclerView.Adapter<RecyclerViewAdapterFavorite.ViewHolder> {
    ...
    public RecyclerViewAdapterFavorite(Context context, ArrayList<Movie> movieArrayList) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterFavorite.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.favorite_movie_row, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterFavorite.ViewHolder holder, int position) {
