...
class LockScreenService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            startForeground(LockScreenApplication.notificationId, notification)
        }
    }

    private fun createNotificationCompatBuilder(): NotificationCompat.Builder {
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val builder = NotificationCompat.Builder(this@LockScreenService, MyNotificationManager.getChannelId())
            builder
        } else {
